...
class OrderController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        if($order)
        {
            ...
            $ship_id = time() . rand(1000, 9999); // Tạo ID vận chuyển từ timestamp và số ngẫu nhiên
            $invoice_id = 'INV-' . date('Ymd') . '-' . rand(1000, 9999); // Tạo ID hóa đơn với prefix và số ngẫu nhiên
