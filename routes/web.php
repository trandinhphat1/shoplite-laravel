...
Route::group( ['prefix'=>'admin/','middleware'=>'auth' ],function(){
    ...
    Route::get('product/stock/{id}',[\App\Http\Controllers\ProductController::class,'stockView'])->name('product.stock');
    Route::post('product/stock/{id}',[\App\Http\Controllers\ProductController::class,'stockUpdate'])->name('product.stock.update');
