                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            <br/>
                                            @php
                                                $shipTrans = $order->shiptrans_id ? \App\Models\Freetransaction::find($order->shiptrans_id) : null;
                                                $shipAmount = $shipTrans ? $shipTrans->amount : 0;
                                            @endphp
                                            <span class="font-medium">
                                                Phí vận chuyển: + {{number_format($shipAmount, 0, '.', ',')}}
                                            </span>
                                        </td>
