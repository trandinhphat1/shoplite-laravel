                                        ...
                                        <div class="report-box zoom-in">
                                            <a   title="Xem chi tiết">
                                                <div class="box p-5">
                                                    ...
                                                    <div class="text-3xl font-medium leading-8 mt-6"><?php echo e(Number_format($tongdon,0,'.',',')); ?> đ</div>
                                        ...
                                        <div class="report-box zoom-in">
                                            <a   title="Xem chi tiết">
                                                <div class="box p-5">
                                                    ...
                                                    <div class="text-3xl font-medium leading-8 mt-6"><?php echo e(Number_format($sohang,0,'.',',')); ?></div>
                                                    <div class="text-base text-slate-500 mt-1">Số hàng hoá</div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO\OneDrive\Máy tính\New folder (6)\shoplite-main\resources\views/backend/index.blade.php ENDPATH**/ ?>